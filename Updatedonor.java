...
{
    JFrame frame = new JFrame("UPDATE DONOR DETAILS");
    ...
    public Updatedonor(){
        ...
        update.setBounds(450, 225, 100, 30);
         ...
         public void actionPerformed(ActionEvent ae) {
            try 
                {   
                    ...
                    int i = stmt.executeUpdate("UPDATE donors "
                    + "SET DONOR_ID=" + ddId.getText() + ", "
                    + "NAME='" + dName.getText() + "', "
                    + "CONTACT_NO=" + dph_no.getText() + ", "
                    + "GENDER='" + dgender.getText() + "', "
                    + "DOB='" + ddob.getText() + "', "
                    + "BLOODGROUP='" + dbloodgroup.getText() + "', "
                    + "STREET ='"+ dstreet.getText() + "',"
                    +"CITY = '" + dcity.getText()+ "',"
                    + "PIN_CODE='" + dpincode.getText()+ "'," 
                    + "STATE='" + dstate.getText()+ "',"
                    + "AGE=" + dage.getText()+ " WHERE donor_id = "
                    + ids.getSelectedItem());
